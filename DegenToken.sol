...
interface IFeeApprover {
    ...
    function setDegenTokenAddress(address _degenTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the Degen team are not responsible for your funds";
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IDegenVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
